...
import { PinIcon, SchoolIcon } from "lucide-react";
    ...
    <section className="relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
        <div className="md:col-span-4 group relative">
          <div className="absolute inset-0 bg-on-surface translate-x-3 translate-y-3 rounded-xl transition-transform group-hover:translate-x-1 group-hover:translate-y-1"></div>
          <div className="relative bg-surface-container-highest border-4 border-on-surface p-2 rounded-xl overflow-hidden aspect-[4/5]">
            <Image
              ...
              fill
            />
            <div className="absolute bottom-4 right-4 bg-primary text-on-primary p-2 rounded-full border-2 border-on-surface">
              <PinIcon />
            </div>
          </div>
        </div>
